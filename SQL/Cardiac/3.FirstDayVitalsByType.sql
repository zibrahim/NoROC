...
drop materialized view if exists CardiacArrest.vitalsfirstday cascade; 

create materialized view CardiacArrest.vitalsfirstday as
		...
		, case
			...
			from CardiacArrest.allevents order by time
